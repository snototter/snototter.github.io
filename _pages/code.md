...
Here you'll find downloads for [software accompanying our publications](#software-pubs), [custom datasets](#datasets), and various [software libraries/utilities](#software-utils).
Publication-related downloads can also be accessed from my [publication list](/publications).
